...
def do_help():
    print("usage: synbeamplot <OpenPMD-series-filename> [option1] ... [optionn] <iter> <h coord> <v coord>")
...
def do_plots(options):
    ...
    plot_density(particles[selected_particles, coords[options.hcoord]],
                 particles[selected_particles, coords[options.vcoord]], options)
