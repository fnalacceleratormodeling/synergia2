        ...
        double brho)
{
    ...
    bool entry_edge_kick = !(lattice_element.get_double_attribute("entry_edge_kick") == 0.0);
    bool exit_edge_kick = !(lattice_element.get_double_attribute("exit_edge_kick") == 0.0);
