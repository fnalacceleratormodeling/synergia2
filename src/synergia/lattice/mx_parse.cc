...
namespace synergia { namespace detail {
  double
  pos(double v)
  {
    return v;
    ...
    constant_()
    {
      this->add("pi", boost::math::constants::pi<double>())(
        ...
        ("degrad", 180.0 / boost::math::constants::pi<double>())(
          ...
          "e", boost::math::constants::e<double>())("emass", pconstants::me)(
          "pmass", pconstants::mp)("mumass", pconstants::mmu)(
          "clight", pconstants::c)("qelect", pconstants::e)("true",
                                                            1.0)("false", 0.0);
    }
  } constant;
...
namespace synergia { namespace {
  ...
  void
  set_flag_attr(mx_attr& attr, boost::optional<char> c, string const& name)
  {
    if (c)
