...
get_uniform_cylindrical_rho2(Space_charge_2d_open_hockney & space_charge,
...
BOOST_FIXTURE_TEST_CASE(get_local_force2_exact_rho,
...
BOOST_FIXTURE_TEST_CASE(get_local_force2_particles,
        Cylindrical_bunch_fixture_fine)
{
    double z_period = 8 * sigma;
    double r0 = 2.0 * sigma;
...
BOOST_FIXTURE_TEST_CASE(get_global_force2_exact_rho,
