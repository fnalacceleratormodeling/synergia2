...
struct propagator_fixture
{
    ...
    , seq_name(sname)
    {
        ...
        // chef propagator
        lattice_chef = reader.get_lattice_sptr(seq_name, "sis18-6.madx");
        ...
        // libff propgator
        lattice_ff = reader.get_lattice_sptr(seq_name, "sis18-6.madx");
...
ELEMENT_FIXTURE(machine);

BOOST_FIXTURE_TEST_CASE( test_machine, machine_fixture )
{
