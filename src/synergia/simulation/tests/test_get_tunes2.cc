...
*/
    ...
    screen << "x tune: " << tunes[0] << " should be " << 0.16533417 << std::endl;
    screen << "y tune: " << tunes[1] << " should be " << 0.436092762 << std::endl;
...
TEST_CASE("get_chromaticities")
{
    ...
    screen << "H chrom: " << chroms.horizontal_chromaticity << " should be " << -65.68223681*beta << std::endl;
    screen << "V chromaticity: " << chroms.vertical_chromaticity << " should be " << -25.5636675*beta << std::endl;
