...
Lattice_simulator::tune_rfcavities(Lattice& lattice)
{
  ...
  // bunch simulator
  auto sim =
    Bunch_simulator::create_single_bunch_simulator(ref, Commxx().size(), 1e09);
...
void
Lattice_simulator::adjust_tunes(Lattice& lattice,
                                double horizontal_tune,
                                double vertical_tune,
                                double tolerance)
{
...
void
Lattice_simulator::adjust_chromaticities(Lattice& lattice,
