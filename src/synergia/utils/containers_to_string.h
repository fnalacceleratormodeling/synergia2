...
map_to_string(std::map<Tkey, Tval> const& c, const char* seperator = ",")
{
  std::ostringstream retval;
  retval << "{";
  for (typename std::map<Tkey, Tval>::const_iterator it = c.begin();
       it != c.end();) {
...
std::string
map_to_string(std::map<Tkey, std::vector<double>> const& c,
              const char* seperator = ",")
{
  std::ostringstream retval;
  retval << "{";
  for (typename std::map<Tkey, std::vector<double>>::const_iterator it =
         c.begin();
       it != c.end();) {
