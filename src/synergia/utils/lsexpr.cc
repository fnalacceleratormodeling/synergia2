...
std::string const& Lsexpr::get_label() const
{
    return label;
}

bool Lsexpr::is_atomic() const
{
    return is_atom;
}
...
void Lsexpr::push_back(Lsexpr const& lsexpr)
{
    sequence.push_back(lsexpr);
}

Lsexpr::const_iterator_t Lsexpr::begin() const
{
    return sequence.begin();
}

Lsexpr::const_iterator_t Lsexpr::end() const
{
    return sequence.end();
}

Lsexpr::iterator_t Lsexpr::begin()
{
    return sequence.begin();
}

Lsexpr::iterator_t Lsexpr::end()
{
    return sequence.end();
}
