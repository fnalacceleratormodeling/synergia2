...
struct Hdf5_exception : public std::exception {
  ...
  private:
    static herr_t
    err_walk(unsigned int n, H5E_error_t const* err_desc, void* client_data)
    {
        ...
        switch (H5Iget_type(hid)) {
            ...
            default:
                throw std::runtime_error(
                    "close of unhandled Hdf5 handler type");
        }
