    ...
    shape(shape), comm(comm), uppers(0), lengths(0)
{
    ...
    // program test_distributed_fft2d_mpi fails when memory_fudge_factor = 1 and
    ...
    //        * memory_fudge_factor);
    //plan = fftw_mpi_plan_dft_r2c_2d(shape[0], shape[1], data, workspace, 
