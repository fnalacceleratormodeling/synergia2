...
/// Commxx object.
void decompose_1d(Commxx const& comm,
                  int length,
                  std::vector<int>& offsets,
                  std::vector<int>& counts);
...
void counts_and_offsets_for_impedance_raw(unsigned int processors,
                                          int length,
                                          std::vector<int>& offsets,
                                          std::vector<int>& counts);

void counts_and_offsets_for_impedance(Commxx const& comm,
                                      int length,
                                      std::vector<int>& offsets,
                                      std::vector<int>& counts);
