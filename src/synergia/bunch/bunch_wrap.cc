    ...
    scope
        Bunch_scope =
            class_<Bunch, Bunch_sptr > ("Bunch", init<Reference_particle const&,
                ...
                .def("expand_local_num", &Bunch::expand_local_num)
                .def("expand_local_spectator_num", &Bunch::expand_local_spectator_num)
                ...
                .def("get_local_num_aligned", &Bunch::get_local_num_aligned)
                .def("get_local_num_padded", &Bunch::get_local_num_padded)
                .def("get_local_num_padding", &Bunch::get_local_num_padding)
                .def("get_local_num_lost", &Bunch::get_local_num_lost)
                .def("get_local_num_slots", &Bunch::get_local_num_slots)
                .def("get_total_num", &Bunch::get_total_num)
                .def("get_local_spectator_num", &Bunch::get_local_spectator_num)
                .def("get_local_spectator_num_aligned", &Bunch::get_local_spectator_num_aligned)
                .def("get_local_spectator_num_padded", &Bunch::get_local_spectator_num_padded)
                .def("get_local_spectator_num_padding", &Bunch::get_local_spectator_num_padding)
                .def("get_local_spectator_num_lost", &Bunch::get_local_spectator_num_lost)
                .def("get_local_spectator_num_slots", &Bunch::get_local_spectator_num_slots)
