...
Bunch::Bunch(
    ...
    , real_num(real_num)
    , parts{ BunchParticles("particles", total_num, *comm),
             BunchParticles("spectators", total_spectator_num, *comm) }
...
Bunch::Bunch()
    ...
    , real_num(1.0)
    , parts{ BunchParticles("particles", 0, *comm), 
             BunchParticles("spectators", 0, *comm) }
    , bunch_index(0)
    , bucket_index(0)
    , array_index(0)
{
