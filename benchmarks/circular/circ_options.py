...
myopts.add("tgridnumx", 64, "x grid cells", int)
myopts.add("tgridnumy", 64, "y grid cells", int)
myopts.add("lgridnum", 128, "", int)
...
myopts.add("partpercell", 4, "", float)
...
job_mgr = workflow.Job_manager("circ.py", myopts,
