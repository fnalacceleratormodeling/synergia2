...
from circ_options import myopts
...
### creating the bunch
    ...
    tgridnumx = myopts.get("tgridnumx")
    tgridnumy = myopts.get("tgridnumy")
    lgridnum = myopts.get("lgridnum")
    griddim = (tgridnumx,tgridnumy,lgridnum)
    ...
    for bunchnum in range(0,numbunches):
        diag=synergia.Diagnostics(gourmet.get_initial_u(),short=True,save_period=0x7fffffffffff)
