...
ldadd = \
    $(fnal_top_objdir)/physics_toolkit/src/.libs/libphysics_toolkit.so \
    $(fnal_top_objdir)/beamline/src/.libs/libbeamline.so \
    $(fnal_top_objdir)/bmlfactory/src/.libs/libbmlfactory.so \
    -lglib-2.0 \
    $(fnal_top_objdir)/basic_toolkit/src/.libs/libbasic_toolkit.so \
    $(fnal_top_objdir)/mxyzptlk/src/.libs/libmxyzptlk.so
