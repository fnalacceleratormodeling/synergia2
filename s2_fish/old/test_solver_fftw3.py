...
class Test_solver_fftw3_open(unittest.TestCase):    
...
class Test_solver_fftw3_open_periodic(unittest.TestCase):    
    def test_01_rough_grid(self):
        shape = (16,16,16)
        size = (2.0,2.0,2.0)
        offset = (0.0,0.0,0.0)
...
if __name__ == '__main__':
    unsuccessful = 0
    solver_suite = unittest.TestLoader().loadTestsFromTestCase(Test_solver_fftw3_open)
