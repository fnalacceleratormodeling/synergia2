...
class Test_Real_scalar_field(unittest.TestCase):
    ...
    def test_02_contruct2(self):
        sf = Real_scalar_field(int3(10,10,10),double3(1.0,1.0,1.0),
                          double3(0.0,0.0,0.0))
    ...
    def test_04_physical_size(self):
        sf = Real_scalar_field(int3(10,10,10),double3(1.0,2.0,3.0),
                          double3(0.0,0.0,0.0))
    ...
    def test_12_get_leftmost_offsets(self):
        sf = Real_scalar_field(int3(2,2,2),double3(10.0,10.0,10.0),
                          double3(5.0,5.0,5.0))
