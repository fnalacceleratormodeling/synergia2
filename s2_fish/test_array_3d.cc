...
main()
{
    ...
    Array_3d<double> x2 = x1;
    x2.print("x2");

    std::cout << "making x3 point to data from x1\n";
    Array_3d<double> x3(4,3,2,x1.get_data_ptr());
    x3.print("x3");
    ...
    std::cout << "x5.offset(1,1,1) = " << x5.offset(1,1,1) << std::endl; 
