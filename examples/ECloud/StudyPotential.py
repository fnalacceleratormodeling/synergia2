...
if ( __name__ == '__main__'):
    ...
    kinetic_energy = 1.0  # Injection energy..Irrelevant, it seems..  
    ...
    current = 5.0 # unspecified units, but does NOT change the potential value. 
    initial_phase = 0.0
#    scaling_frequency = 10221.05558e6 # Angular frequency 
    scaleDef = 2.5 # Arbitrary Ratio of beam width to Synergia length or "Angular Frequency" 
    ...
    xwidth=0.0050/scaleDef   # I hope my beam width is 3.2 mm  
    ywidth=xwidth   # same 
...
#
    ...
    print " Bunch sigmas, before propagation, x =  ", sigXNow, 
...
#    total_charge = deposit_charge_cic(rho,bunch.get_store(),0)
    total_charge = deposit_charge_ngp(rho,bunch.get_store())
