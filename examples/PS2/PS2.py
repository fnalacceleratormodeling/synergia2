...
if ( __name__ == '__main__'):
    ...
    myopts.add("xoffset",0.00000,"transverse offset in x",float)
    myopts.add("yoffset",0.00000,"transverse offset in y",float)
   ...
   # myopts.add("bunches",1,"",int)
    myopts.add("saveperiod",50,"save beam each <saveperiod> turns",int)
