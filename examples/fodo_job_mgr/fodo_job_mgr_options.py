...
opts = synergia_workflow.Options("fodo_job_mgr")
...
# Create the job manager for the simulation fodo_job_mgr.py, including the 
# above options. When creating job directories, include the file fodo.lat.
job_mgr = synergia_workflow.Job_manager("fodo_job_mgr.py", opts, ["fodo.lat"])
