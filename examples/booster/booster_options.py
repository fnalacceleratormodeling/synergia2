...
opts.add("wave_number",[0,0,0],"wave number for multibunch instability",int)
...
opts.add("spc_comm_size", 32, " optimal number of proccs for space_charge, machine dependent", int)
...
opts.add("checkpointperiod", 10, "Number of turns to run between checkpoints", int)
