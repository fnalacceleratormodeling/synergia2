...
opts.add("rf_volt", 0.00, "RF voltage [MV]")
opts.add("lag", 0.0, "rf cavity phase in units of 2*pi")

opts.add("matching", "uniform", "matching procedure 6dmoments|uniform|airbag")
...
opts.add("steps", 1, "# steps/element")
...
opts.add("particles_period", 100, "0: save every turn, n!=0, save particles every n turns")
