...
opts = Options("idealcomp2")
#opts.add("spacecharge", 1, "which space charge calculation: 0=None, 1=Hockney")
opts.add("lattice_file", "el_idealcomp.lsx", "lattice file to run")
...
elens_JL  = 24.0
opts.add("elensradius", 0.00419, "electron lens beam radius [m]")
...
opts.add("num_steps", 24, "number of steps for independent stepper")
...
# These are the beta functions for at the lenses 
# tune is set to 0.74
beta_x = 17.2336287
beta_y = 17.2336287
...
opts.add("measurepoint", "boc", "Element for measurements")
...
job_mgr = Job_manager("cxx_idealcomp", opts,
                      ["el_idealcomp.lsx"],
                       standalone=True)
