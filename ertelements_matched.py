...
###    sys.exit(1)
    ...
    #~ alphax =  0.4982
    #~ alphay = -2.3771
    (alphax,alphay,rtbetax,rtbetay) = matching.get_alpha_beta(g_returncellc)
    ...
    print "(alphax,alphay,rtbetax,rtbetay) =",(alphax,alphay,rtbetax,rtbetay)
