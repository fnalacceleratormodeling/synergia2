...
opts.add("partpercell", 1, "macro particles per grid cell", float)
...
opts.add("gridx", 16, "size of transverse grid for solver", int)
opts.add("gridy", 16, "size of transverse grid for solver", int)
opts.add("gridz", 16, "size of longitudinal grid for solver", int)
