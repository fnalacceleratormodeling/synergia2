...
from trackmem_module import Trackmem_actions
...
macro_particles = int(gridx * gridy * gridz * partpercell)
...
max_turns = 0
trackmem_actions = Trackmem_actions()
propagator.set_checkpoint_period(2*num_turns)
propagator.propagate(bunch_simulator, trackmem_actions, num_turns, max_turns, verbose)
