...
def propagate():
    ...
    for i in range(num_bunches):
        bunch_train_simulator.add_per_turn(i, synergia.bunch.Diagnostics_bulk_track(f"le_tracks_{i:02d}.h5",
                                                                           4))
        bunch_train_simulator.add_per_turn(i, synergia.bunch.Diagnostics_full2(f"le_diag_{i:02d}.h5"))

        bunch_train_simulator.add_per_turn(i, synergia.bunch.Diagnostics_particles(f"le_particles_{i:02d}.h5"))
