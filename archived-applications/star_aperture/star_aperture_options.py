...
opts = synergia_workflow.Options("star_aperture")
opts.add("macro_particles", 10000, "Number of macro particles", int)
opts.add("aperture", "elliptical", "Aperture type (either 'circular', 'elliptical', 'rectangular', 'polygon', or 'wire_elliptical'")
