#!/bin/bash
echo "use like that:  ./run_modes.sh working_directory executable_name resume_executable lattice_xml_file input_options_file 
...
. "/home/macridin/synergia2-devel/setup.sh"
...
mpirun -np $numproc $working_directory/$executable
...
mpirun -np $numproc $working_directory/$resume_executable
