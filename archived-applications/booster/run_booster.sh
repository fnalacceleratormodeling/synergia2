#!/bin/bash
echo "use like that:  ./run_booster.sh working_directory executable_name resume_executable lattice_xml_file input_options_file 
...
. "/home/macridin/synergia2-merge/setup.sh"
