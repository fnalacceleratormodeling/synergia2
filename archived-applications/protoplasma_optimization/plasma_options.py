...
opts = synergia_workflow.Options("nlopt")
...
opts.add("num_steps", 10, "Number of steps per turn", int)
...
job_mgr = synergia_workflow.Job_manager("plasma.py", opts, ["tevatron.lat"])
